...
class Evidence(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ Primitive extension for exposureVariant. List of `FHIRPrimitiveExtension` """
        ...
        List of `FHIRReference` items (represented as `dict` in JSON). """
        self._outcome = None
        """ Primitive extension for outcome. List of `FHIRPrimitiveExtension` """
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_exposureVariant", "_exposureVariant", fhirprimitiveextension.FHIRPrimitiveExtension, True, None, False),
            ...
            ("_outcome", "_outcome", fhirprimitiveextension.FHIRPrimitiveExtension, True, None, False),
